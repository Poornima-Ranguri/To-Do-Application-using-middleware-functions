...
const authenticateQueryToken = async (request, response, next) => {
...
const authenticateBodyToken = (request, response, next) => {
...
app.get("/todos/", authenticateQueryToken, async (request, response) => {
...
//GET Todo API-2
app.get("/todos/:todoId", authenticateQueryToken, async (request, response) => {
...
//GET Agenda API-3
app.get("/agenda/", authenticateQueryToken, async (request, response) => {
  const { date } = request;
  console.log(date, "a");
...
//Add Todo API-4
app.post("/todos/", authenticateBodyToken, async (request, response) => {
...
//Update Todo API-5
app.put("/todos/:todoId/", authenticateBodyToken, async (request, response) => {
  const { todoId } = request;
